class Dropdown {
    constructor(container) {
      ...
      this.button = container.querySelector(".dropdown_button");
      this.menu = container.querySelector(".dropdown_menu");
      this.items = container.querySelectorAll(".dropdown_menu_item");
    }
