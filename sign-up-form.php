                                ...
                                <form id="form" method="post" name="emailform" action="email.php">
                                    ...
                                    <div class="form-input-max">
                                        <div class="gender_box">
                                            ...
                                            <label class="radio_container radio_text">Male
                                                <input type="radio" name="radio">
                                                <span class="checkmark"></span>
                                            </label>
                                            <label class="radio_container radio_text">Female
                                                <input type="radio" name="radio">
                                                <span class="checkmark"></span>
                                            </label>
                                            <label class="radio_container radio_text">Others
                                                <input type="radio" name="radio">
                                                <span class="checkmark"></span>
                                            </label>
                                        </div>
                                        <div class="image_box">
                                            <p class="form-text">Upload Profile Image</p>
                                            <div class="box">
